...
public class Console {
    public static void main(String[] args) {
        ...
        System.out.printf("Salary: %.2f %n", 1234.5678);
...
// Mas quando o rodamos,
// o que é impresso no console
// (contendo os inputs) é o seguinte:
//
//Qual a sua idade? 25
...
//
//Então, o que acontece é: "Qual a sua idade?" é impresso,
// digitamos o valor e apertamos enter. Quando fazemos isso,
// o buffer de entrada fica com o conteúdo "25\n", e quando o nextInt()
// faz a leitura, ele lê apenas o 25, deixando o "\n" para trás. Depois disso,
// "Qual o seu nome?" é impresso, e o método nextLine() vai ler tudo que estiver no
//buffer de entrada até encontrar um "\n". Como o nextInt() deixou um "\n"
// para trás, é esse o valor que o nextLine() lê. Isso conclui a leitura e a
...
// nextInt(), de modo que o código abaixo vai funcionar da maneira como queríamos.
//
//          Scanner teclado = new Scanner(System.in);
//
//          System.out.println("Qual a sua idade?");
